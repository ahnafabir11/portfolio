...
export default function Contact() {
  ...
  return (
    <main className="mx-auto py-10 h-screen container">
      <WavyBackground
        speed="slow"
      ...
      >
        ...
        <div className="flex-1">
          <div className="bg-black bg-opacity-75 shadow-input mx-auto p-4 md:p-8 rounded-2xl w-full max-w-md">
            ...
            <form className="pt-8">
              <div className="flex md:flex-row flex-col md:space-x-2 space-y-2 md:space-y-0 mb-4">
                <LabelInputContainer>
                  <Label htmlFor="firstname">First name</Label>
                  <Input type="text" id="firstname" placeholder="Tyler" />
                </LabelInputContainer>
                <LabelInputContainer>
                  <Label htmlFor="lastname">Last name</Label>
                  <Input type="text" id="lastname" placeholder="Durden" />
                </LabelInputContainer>
              </div>
