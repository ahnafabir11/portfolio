...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="md:min-h-[200vh] flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <Image
          src={src as string}
          alt="ahnaf abir\'s project screenshot"
          fill
          className="object-cover object-center absolute rounded-lg inset-0 h-full w-full p-1"
        />
      </motion.div>
    </div>
  );
